...
set.seed(30)
ggraph(g, layout = "fr") +
  geom_edge_link(alpha = .3, color = "brown", width = 0.8) + 
  geom_node_point(color = "firebrick", size = 4, alpha = 0.7) + 
  geom_node_text(aes(label = name), repel = TRUE, size = 3, color = "darkred") +
